------------------------------------------------------------------------------
-- final_project_peripheral.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          final_project_peripheral.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Sun Dec 03 05:41:37 2017 (by Create and Import Peripheral Wizard)
...
library final_project_peripheral_v1_00_a;
use final_project_peripheral_v1_00_a.user_logic;
...
entity final_project_peripheral is
  generic
  (
...
end entity final_project_peripheral;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of final_project_peripheral is
  ...
  constant IPIF_ARD_ADDR_RANGE_ARRAY      : SLV64_ARRAY_TYPE     := 
    (
      ...
      ZERO_ADDR_PAD & C_MEM6_BASEADDR,    -- user logic memory space 6 base address
      ZERO_ADDR_PAD & C_MEM6_HIGHADDR,    -- user logic memory space 6 high address
      ZERO_ADDR_PAD & C_MEM7_BASEADDR,    -- user logic memory space 7 base address
      ZERO_ADDR_PAD & C_MEM7_HIGHADDR     -- user logic memory space 7 high address
    );

  ------------------------------------------
  -- Array of desired number of chip enables for each address range
  ------------------------------------------
  constant USER_SLV_NUM_REG               : integer              := 4096;
  ...
  constant IPIF_ARD_NUM_CE_ARRAY          : INTEGER_ARRAY_TYPE   := 
    (
      ...
      3  => 1,                            -- number of ce for user logic memory space 2 (always 1 chip enable)
      4  => 1,                            -- number of ce for user logic memory space 3 (always 1 chip enable)
      5  => 1,                            -- number of ce for user logic memory space 4 (always 1 chip enable)
      6  => 1,                            -- number of ce for user logic memory space 5 (always 1 chip enable)
      7  => 1,                            -- number of ce for user logic memory space 6 (always 1 chip enable)
      8  => 1                             -- number of ce for user logic memory space 7 (always 1 chip enable)
    );
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity final_project_peripheral_v1_00_a.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "010000000" => ipif_IP2Bus_Data <= user_IP2Bus_Data;
      when "001000000" => ipif_IP2Bus_Data <= user_IP2Bus_Data;
